...
@protocol IATMidiByteDecriptionProtocol <NSObject>
...
@interface IATMidiByteDescription : NSObject
...
@interface IATMidiByteDescriptionObject : NSObject <IATMidiByteDecriptionProtocol>
